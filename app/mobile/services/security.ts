...
const SECURITY_SETTINGS_KEY = " StellarFoundry.security.settings";
const FALLBACK_PIN_HASH_KEY = " StellarFoundry.security.pinHash";
const SENSITIVE_TOKEN_KEY = " StellarFoundry.security.sensitiveToken";
const PIN_HASH_SALT = " StellarFoundry.v2.pin.salt";
