...
const SYNC_SETTINGS_KEY = " StellarFoundry.background-sync.settings.v1";
const SYNC_SNAPSHOT_KEY = " StellarFoundry.background-sync.snapshot.v1";
const SYNC_TASK_NAME = " StellarFoundry.background-sync.task";
