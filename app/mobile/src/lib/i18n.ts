  ...
  resources: {
    en: {
      translation: {
        ...
        recipientAssetDescription:
          "Same as the amount currency above — what lands in the receiver's account after the path executes.",
        allowedSourceAssets: "Allowed source assets (payers)",
        allowedSourceAssetsDescription:
          "Payers may use any of the selected assets; Horizon suggests paths and send amounts.",
        pathPreview: "Path preview",
        fetchingEstimates: "Fetching estimates…",
        noPathsFound:
          "No paths found for this combination on {{horizonUrl}}. Try other source assets or a smaller amount.",
        payReceive:
        ...
        sorobanPreflightDescription:
          "Runs the same simulation as POST /transactions/compose with health_check on  StellarFoundry_CONTRACT_ID.",
    ...
    es: {
      translation: {
        ...
        recipientAssetDescription:
          "Igual a la moneda de la cantidad anterior — lo que llega a la cuenta del receptor después de que se ejecute la ruta.",
        allowedSourceAssets: "Activos fuente permitidos (pagadores)",
        allowedSourceAssetsDescription:
          "Los pagadores pueden usar cualquiera de los activos seleccionados; Horizon sugiere rutas y envía cantidades.",
        pathPreview: "Vista previa de ruta",
        fetchingEstimates: "Obteniendo estimaciones…",
        noPathsFound:
          "No se encontraron rutas para esta combinación en {{horizonUrl}}. Prueba otros activos fuente o una cantidad menor.",
        payReceive:
          "Pagar {{sourceAmount}} ({{sourceAsset}}) → recibir {{destinationAmount}} ({{destinationAsset}})",
        hops: "Saltos: {{hopCount}}",
        sorobanPreflight: "Preflight de Soroban (compositor)",
        sorobanPreflightDescription:
          "Ejecuta la misma simulación que POST /transactions/compose con health_check en  StellarFoundry_CONTRACT_ID.",
    ...
    fr: {
      translation: {
        ...
        advancedModeDescription:
          "Le mode avancé prend en charge les paiements de chemin : choisissez ce que vous recevez et laissez les payeurs se liquider dans plusieurs actifs.",
        ...
        recipientAssetDescription:
          "Identique à la devise du montant ci-dessus — ce qui arrive sur le compte du destinataire après l'exécution du chemin.",
        allowedSourceAssets: "Actifs source autorisés (payeurs)",
        allowedSourceAssetsDescription:
          "Les payeurs peuvent utiliser n'importe quel actif sélectionné ; Horizon suggère des chemins et envoie des montants.",
        pathPreview: "Aperçu du chemin",
        fetchingEstimates: "Récupération des estimations…",
        noPathsFound:
          "Aucun chemin trouvé pour cette combinaison sur {{horizonUrl}}. Essayez d'autres actifs source ou un montant plus petit.",
        payReceive:
          "Payer {{sourceAmount}} ({{sourceAsset}}) → recevoir {{destinationAmount}} ({{destinationAsset}})",
        hops: "Sauts : {{hopCount}}",
        sorobanPreflight: "Pré-vol Soroban (compositeur)",
        sorobanPreflightDescription:
          "Exécute la même simulation que POST /transactions/compose avec health_check sur  StellarFoundry_CONTRACT_ID.",
