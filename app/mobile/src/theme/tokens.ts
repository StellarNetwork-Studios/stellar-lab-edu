...
export type ThemeId = "light" | "dark" | " StellarFoundry-blue" | "pulsefy-purple";
...
/**
 * Brand:  StellarFoundry Blue
 * Deep navy base with electric blue accents.
 * Contrast-checked: textPrimary (#F0F4FF) on background (#0B1120) = 16.8:1 ✓
 */
export const StellarFoundryBlueTheme: ThemeTokens = {
  id: " StellarFoundry-blue",
  name: " StellarFoundry Blue",
  isDark: true,
...
export const ThemeRegistry: Record<ThemeId, ThemeTokens> = {
  light: LightTheme,
  dark: DarkTheme,
  " StellarFoundry-blue": StellarFoundryBlueTheme,
