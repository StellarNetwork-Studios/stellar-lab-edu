 ...
 *   `@ StellarFoundry/theme/<profileId>`.
 */
...
function storageKey(profileId: string): string {
  return `@ StellarFoundry/theme/${profileId}`;
}
...
export function StellarFoundryThemeProvider({
  profileId = "default",
  children,
}: ThemeProviderProps) {
...
export function useTheme(): ThemeContextValue {
  ...
  if (!ctx) {
    throw new Error(
      "useTheme must be used within a < StellarFoundryThemeProvider>",
    );
  }
  return ctx;
}
