...
export const GlobalNetworkBanner = () => {
      ...
      <SafeAreaView style={[styles.safeArea, styles.bgStaging]}>
        <View style={styles.container}>
          ...
          <Text style={[styles.subtext, styles.textStaging]}>
            {guard.isConnected
              ? `Connected to ${guard.currentNetwork.toUpperCase()} • Backend: staging-api. StellarFoundry.to`
  ...
  return (
    <SafeAreaView
      style={[styles.safeArea, isMismatch ? styles.bgError : styles.bgWarning]}
    >
      <View style={styles.container}>
        <Text
          style={[
            styles.text,
            isMismatch ? styles.textError : styles.textWarning,
          ]}
        >
