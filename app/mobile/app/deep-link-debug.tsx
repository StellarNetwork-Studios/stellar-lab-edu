...
const EXAMPLE_LINKS = [
  "https:// StellarFoundry.to/jordan?amount=12.5&asset=XLM",
  " StellarFoundry://transaction/tx_demo_12345?status=Success",
  "https:// StellarFoundry.to/transaction/tx_demo_12345",
  " StellarFoundry://alice?amount=1.25&asset=USDC&privacy=true",
  "https:// StellarFoundry.to/transaction/tx_demo_12345?memo=coffee",
];
    ...
    >
      ...
      >
        ...
        <Text style={[styles.subtitle, { color: theme.textSecondary }]}>
          Validate StellarFoundry deep link parsing and preview the target route.
        </Text>
        ...
        >
          ...
          {"route" in result ? (
            ...
            <Text style={[styles.resultValue, { color: theme.textPrimary }]}>
              No StellarFoundry link detected.
            </Text>
          )}
        </View>
