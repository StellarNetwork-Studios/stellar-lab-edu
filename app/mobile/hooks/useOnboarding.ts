...
const ONBOARDING_STORAGE_KEY = " StellarFoundry_onboarding_completed";
const ANALYTICS_STORAGE_KEY = " StellarFoundry_onboarding_events";
...
export function useOnboarding() {
  ...
  const getOrCreateSessionId = async (): Promise<string> => {
    const SESSION_ID_KEY = " StellarFoundry_session_id";
    try {
