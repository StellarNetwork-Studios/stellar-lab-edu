...
This guide covers deploying the StellarFoundry frontend to Vercel with Preview Deployments for PRs and Production deployments from the main branch.
...
```
NEXT_PUBLIC_ StellarFoundry_API_URL=https://api. StellarFoundry.to
NEXT_PUBLIC_SITE_URL=https:// StellarFoundry.to
...
```
NEXT_PUBLIC_ StellarFoundry_API_URL=https://api-staging. StellarFoundry.to
...
```
NEXT_PUBLIC_ StellarFoundry_API_URL
...
2. Add your custom domain (e.g., ` StellarFoundry.to`)
