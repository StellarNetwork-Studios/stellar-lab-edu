...
export default function Generator() {
  ...
  const apiBase = useMemo(() => getStellarFoundryApiBase(), []);
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-3xl text-sm text-neutral-400">
                  ...
                  Each row needs a positive amount and either a  StellarFoundry username or a Stellar destination.
                </p>
              </div>
                    ...
                    >
                      ...
                      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <input
                          ...
                          placeholder=" StellarFoundry username"
                          className={`rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-sm text-white ${FOCUS_RING_CLASS}`}
                        />
                        <input
                          type="text"
              ...
              <div className="mt-8 rounded-[32px] border border-emerald-300/25 bg-emerald-500/10 p-6">
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  <button
                    ...
                    onClick={() =>
                      downloadBrowserFile(
                        ` StellarFoundry-batch-links-${new Date().toISOString().slice(0, 10)}.csv`,
