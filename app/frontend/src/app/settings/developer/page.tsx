...
async function apiFetch<T>(path: string, init?: RequestInit): Promise<T> {
  const res = await fetch(`${getStellarFoundryApiBase()}${path}`, {
    ...init,
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-neutral-500 mt-1">
                  Manage keys used to authenticate requests to the  StellarFoundry API.
                </p>
              </div>
              <button
          ...
          <section className="p-6 rounded-3xl bg-neutral-900/40 border border-white/5 space-y-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                { scope: "usernames:read",    desc: "Look up registered  StellarFoundry usernames." },
              ].map(({ scope, desc }) => (
                <div
                  key={scope}
