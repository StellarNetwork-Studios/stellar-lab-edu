    ...
    <div className="relative min-h-screen text-white">
      ...
      <main className="relative z-10 p-4 sm:p-6 md:p-12 md:ml-72">
        ...
        <nav className="flex gap-3 mb-8">
          <Link
            href="/settings"
            className="px-4 py-2 rounded-xl border border-white/10 text-sm font-semibold hover:bg-white/5 transition"
          >
            General
          </Link>
          <Link
            href="/settings/teams"
            className="px-4 py-2 rounded-xl border border-white/10 bg-white/10 text-sm font-semibold"
          >
            Team
          </Link>
          <Link
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl bg-white/5 border border-white/5">
            <p className="text-indigo-400 font-black text-xs uppercase mb-2">
              Admin
            </p>
            <p className="text-sm text-neutral-400">
              Full access to all settings, team management, and financial
              operations.
            </p>
          </div>
          <div className="p-6 rounded-2xl bg-white/5 border border-white/5">
            <p className="text-purple-400 font-black text-xs uppercase mb-2">
              Operator
            </p>
            <p className="text-sm text-neutral-400">
              Can manage links and view analytics, but cannot manage team or
              workspace settings.
            </p>
          </div>
          <div className="p-6 rounded-2xl bg-white/5 border border-white/5">
            <p className="text-neutral-400 font-black text-xs uppercase mb-2">
              Viewer
            </p>
            <p className="text-sm text-neutral-400">
              Read-only access to dashboard and analytics. Cannot perform any
              actions.
            </p>
          </div>
        </div>
