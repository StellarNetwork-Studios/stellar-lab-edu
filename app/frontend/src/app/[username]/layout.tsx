...
export async function generateMetadata({
  ...
  const title = `@${safeUsername} — Pay with  StellarFoundry`;
  const description = `Send a payment to @${safeUsername} on the Stellar network using  StellarFoundry. Fast, private, and fee-efficient.`;
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${safeUsername} on  StellarFoundry`,
        },
      ],
    },
    twitter: {
