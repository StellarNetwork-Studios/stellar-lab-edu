...
This document is the single source of truth for building, testing, and deploying the StellarFoundry Soroban contract.
...
```text
target/wasm32-unknown-unknown/release/ StellarFoundry.wasm
```
