...
This document describes the contract-level safeguards and invariant enforcement mechanisms for safe, controlled upgrades in StellarFoundry.
...
- [ StellarFoundry Invariant Checks](./UPGRADE_SAFETY_GATE.md) (this file)
- [`storage.rs::assert_post_upgrade_invariants()`](../contracts/ StellarFoundry/src/storage.rs)
- [`admin.rs::start_upgrade()`, `complete_upgrade()`](../contracts/ StellarFoundry/src/admin.rs)
