...
```bash
cd app/contract/contracts/ StellarFoundry
...
test result: ok. 5 passed; 0 failed; 0 ignored; 0 measured
   ...
   Doc-tests  StellarFoundry: 0 passed; 0 failed; 0 ignored; 0 measured
```
...
- **Test Code**: `app/contract/contracts/ StellarFoundry/src/upgrade_test.rs` (lines 660–820)
- **Implementation**: `app/contract/contracts/ StellarFoundry/src/admin.rs`, `storage.rs`, `events.rs`
