...
mod tests {
    ...
    fn replay_same_nonce_fails_with_nonce_already_used() {
        ...
        ctx.env.as_contract(&contract_id, || {
            ...
            assert_eq!(result, Err( StellarFoundryError::NonceAlreadyUsed));
        });
    }
    ...
    fn expired_signature_fails_with_signature_expired() {
        ...
        ctx.env.as_contract(&contract_id, || {
            ...
            assert_eq!(result, Err( StellarFoundryError::SignatureExpired));
        });
    }
    ...
    fn non_sequential_nonces_are_independent() {
        ...
        ctx.env.as_contract(&contract_id, || {
            ...
            assert_eq!(
                ...
                Err( StellarFoundryError::NonceAlreadyUsed)
            );
        });
    }
