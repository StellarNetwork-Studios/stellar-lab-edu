...
use crate::{ StellarFoundryContract,  StellarFoundryContractClient};
use soroban_sdk::{
...
fn test_escrow_id_rejects_negative_amount() {
    ...
    assert_eq!(result, Err(Ok(crate::errors:: StellarFoundryError::InvalidAmount)));
}
...
fn test_escrow_id_rejects_oversized_salt() {
    ...
    assert_eq!(result, Err(Ok(crate::errors:: StellarFoundryError::InvalidSalt)));
}
