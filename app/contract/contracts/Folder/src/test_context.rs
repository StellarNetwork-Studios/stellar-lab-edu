//! Shared test scaffolding for  StellarFoundry contract tests.
//!
...
use crate::{types::FeeConfig,  StellarFoundryContract,  StellarFoundryContractClient};

/// Test harness for  StellarFoundry contract tests.
///
...
pub struct TestContext<'a> {
    ...
    pub client:  StellarFoundryContractClient<'a>,
    pub admin: Address,
