...
use crate::{errors::StellarFoundryError, oracle, storage, types::FeeRatio};
...
pub fn apply_fee_ratio(amount: i128, ratio: &FeeRatio) -> Result<i128, StellarFoundryError> {
    ...
    let scaled = amount
        ...
        .ok_or(StellarFoundryError::InvalidFeeConfiguration)?;
