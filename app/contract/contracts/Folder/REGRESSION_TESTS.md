# StellarFoundry upgrade / regression test suite

This document describes the **regression test suite** used to future-proof StellarFoundry: after contract or SDK upgrades, these tests ensure existing escrows and commitments still behave correctly.
...
From the **contract directory** (`app/contract/contracts/ StellarFoundry/`):
