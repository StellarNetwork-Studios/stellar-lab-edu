...
This document describes how the StellarFoundry Soroban contract handles both Native XLM and Stellar Asset Contract (SAC) assets across all flows.
...
The StellarFoundry contract successfully handles both Native XLM and SAC tokens through:
...
This design ensures reliability, simplicity, and extensibility for the StellarFoundry platform.
