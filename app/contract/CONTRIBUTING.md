# Contributing to StellarFoundry Privacy Contract

Thank you for your interest in contributing to the StellarFoundry privacy contract! This document outlines the development guidelines, code standards, and contribution workflow for this Soroban smart contract.
...
- **Structs**: `PascalCase` (e.g., ` StellarFoundryContract`)
