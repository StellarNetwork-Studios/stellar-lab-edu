...
exports.SCAM_RULES = exports.ScamAlertType = exports.ScamSeverity = exports.FREQUENCY_THRESHOLD = exports.ACCOUNT_AGE_THRESHOLDS = exports.SUSPICIOUS_MEMO_PATTERNS = exports.EXTERNAL_BLOCKLIST_SOURCES = exports.BLACKLISTED_RECIPIENTS = exports.MAX_REASONABLE_AMOUNTS = exports.HIGH_VALUE_THRESHOLDS = exports.WHITELISTED_ASSETS = exports.ASSETS_REQUIRING_MEMO = void 0;
/**
 * Assets that require memo for identification
 */
exports.ASSETS_REQUIRING_MEMO = [
    "USDC",
    "USDT",
    "XLM",
    "EUR",
 ...
 */
exports.MAX_REASONABLE_AMOUNTS = {
 ...
 */
exports.BLACKLISTED_RECIPIENTS = [
    "scammer.com",
    "phishing-site.net",
    "fake-exchange",
    "not-real-wallet",
 ...
 */
exports.EXTERNAL_BLOCKLIST_SOURCES = [
    {
    ...
    {
        name: " StellarFoundry Community Blocklist",
        url: "https://blocklist. StellarFoundry.io/api/v1/blocklist",
        method: "GET",
    },
];
/**
 ...
 */
exports.SUSPICIOUS_MEMO_PATTERNS = [
 ...
 */
exports.ACCOUNT_AGE_THRESHOLDS = {
 ...
 */
var ScamSeverity;
(function (ScamSeverity) {
    ScamSeverity["LOW"] = "low";
    ScamSeverity["MEDIUM"] = "medium";
    ScamSeverity["HIGH"] = "high";
    ScamSeverity["CRITICAL"] = "critical";
})(ScamSeverity || (exports.ScamSeverity = ScamSeverity = {}));
/**
 * Scam alert types
 */
var ScamAlertType;
(function (ScamAlertType) {
    ScamAlertType["MISSING_MEMO"] = "missing_memo";
    ScamAlertType["HIGH_AMOUNT"] = "high_amount";
    ScamAlertType["UNKNOWN_ASSET"] = "unknown_asset";
    ScamAlertType["SUSPICIOUS_MEMO"] = "suspicious_memo";
    ScamAlertType["EXTERNAL_ADDRESS_IN_MEMO"] = "external_address_in_memo";
    ScamAlertType["URGENCY_PATTERN"] = "urgency_pattern";
    ScamAlertType["BLACKLISTED_RECIPIENT"] = "blacklisted_recipient";
    ScamAlertType["HIGH_VALUE_MISSING_MEMO"] = "high_value_missing_memo";
    ScamAlertType["NEWLY_CREATED_ACCOUNT"] = "newly_created_account";
    ScamAlertType["HIGH_FREQUENCY_LOW_VALUE"] = "high_frequency_low_value";
    ScamAlertType["BLACKLISTED_EXTERNAL"] = "blacklisted_external";
})(ScamAlertType || (exports.ScamAlertType = ScamAlertType = {}));
/**
 * Rule configurations with severity
 */
exports.SCAM_RULES = (_a = {},
    _a[ScamAlertType.MISSING_MEMO] = {
    ...
    _a[ScamAlertType.UNKNOWN_ASSET] = {
        severity: ScamSeverity.MEDIUM,
    ...
    _a[ScamAlertType.SUSPICIOUS_MEMO] = {
    ...
    _a[ScamAlertType.EXTERNAL_ADDRESS_IN_MEMO] = {
        severity: ScamSeverity.CRITICAL,
        message: "Memo contains what appears to be an external wallet address",
        recommendation: "STOP! Never send funds to addresses in memos. This is a scam.",
    },
    _a[ScamAlertType.URGENCY_PATTERN] = {
        severity: ScamSeverity.HIGH,
    ...
    _a[ScamAlertType.BLACKLISTED_EXTERNAL] = {
        severity: ScamSeverity.CRITICAL,
