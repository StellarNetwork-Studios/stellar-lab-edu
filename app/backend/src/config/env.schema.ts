...
export const envSchema = Joi.object({
  ...
  CORS_ALLOWED_ORIGINS: Joi.string()
    ...
    .optional()
    .description(
      "Comma-separated list of allowed CORS origins (e.g. https:// StellarFoundry.to,https://app. StellarFoundry.to). " +
  ...
  CORS_VERCEL_PROJECT: Joi.string()
    ...
    .optional()
    .description(
      "Vercel project slug (e.g.  StellarFoundry-frontend). " +
  ...
  SENDGRID_FROM_EMAIL: Joi.string()
    ...
    .optional()
    .description(
      "From address for SendGrid emails (e.g. noreply@ StellarFoundry.to)",
    ),
...
export interface EnvConfig {
  ...
  StellarFoundry_CONTRACT_ID?: string;
