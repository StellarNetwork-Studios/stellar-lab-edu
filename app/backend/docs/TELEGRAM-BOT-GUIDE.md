...
StellarFoundry now supports real-time notifications via Telegram! Users can link their Telegram accounts to receive instant alerts for:
...
Users can link their StellarFoundry account to Telegram by:
...
2. **Sending their public key**
   - The bot will prompt for their StellarFoundry public key
   - User sends their Stellar public key (starts with `G...`)

3. **Verification**
   - The bot generates a verification code
   - User enters this code in the StellarFoundry app/website
...
| `/unlink`       | Disconnect Telegram from StellarFoundry  |
...
Bot: 👋 Welcome to  StellarFoundry Notifications Bot!
...
[User verifies on  StellarFoundry platform]
