...
This guide covers contribution standards for the StellarFoundry backend.
...
```bash
pnpm turbo run dev --filter=@ StellarFoundry/backend
```
...
```bash
pnpm turbo run test --filter=@ StellarFoundry/backend
```
...
- [ ] `pnpm turbo run type-check --filter=@ StellarFoundry/backend` passes
- [ ] `pnpm turbo run lint --filter=@ StellarFoundry/backend` passes
- [ ] `pnpm turbo run test --filter=@ StellarFoundry/backend` passes
...
# Type checking
pnpm turbo run type-check --filter=@ StellarFoundry/backend

# Linting
pnpm turbo run lint --filter=@ StellarFoundry/backend

# Build
pnpm turbo run build --filter=@ StellarFoundry/backend
```
