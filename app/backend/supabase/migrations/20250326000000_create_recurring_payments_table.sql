...
CREATE TABLE IF NOT EXISTS recurring_payment_links (
  ...
  -- Link identification
  username TEXT,  -- Optional:  StellarFoundry.to/username route
...
COMMENT ON COLUMN recurring_payment_links.username IS 'Optional username route ( StellarFoundry.to/username)';
