...
CREATE OR REPLACE FUNCTION  StellarFoundry_analytics_summary(
  p_public_key TEXT,
...
CREATE OR REPLACE FUNCTION  StellarFoundry_analytics_asset_distribution(
  p_public_key TEXT,
  p_start_date TIMESTAMPTZ,
  p_end_date TIMESTAMPTZ
)
...
CREATE OR REPLACE FUNCTION  StellarFoundry_analytics_time_series(
  p_public_key TEXT,
  p_start_date TIMESTAMPTZ,
  p_end_date TIMESTAMPTZ,
