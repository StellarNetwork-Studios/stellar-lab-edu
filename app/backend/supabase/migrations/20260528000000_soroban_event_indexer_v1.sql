...
COMMENT ON TABLE privacy_events IS 'PrivacyToggled events from the  StellarFoundry Soroban contract.';
...
COMMENT ON TABLE admin_events IS 'Admin action events from the  StellarFoundry Soroban contract.';
...
COMMENT ON TABLE stealth_events IS 'Stealth address events from the  StellarFoundry Soroban contract.';
