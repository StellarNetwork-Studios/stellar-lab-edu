-- Usernames table for  StellarFoundry.to/yourname
...
COMMENT ON TABLE usernames IS 'Registered usernames ( StellarFoundry.to/yourname). Username is stored normalized (lowercase).';
